...
## `GET /api/goalkeepers/document-types`
...
- The set returned here is exactly the set of valid `documentType` values accepted by `PATCH /api/goalkeepers/me/identification`.
